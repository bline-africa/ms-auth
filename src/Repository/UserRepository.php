    ...
    */
    ...
    public function findByType($role = "ROLE_PROVIDER", $id = 1)
    {
        ...
        return $query = $this->getEntityManager()
            ...
            ->executeQuery(
                <<<'SQL'
            SELECT id,lastname,firstname,username,createdAt,email,isvalid,is_kyc_check,account_type,title,fax,company_name,address,phone1,phone2,last_connect,title,fax,tva,is_deleted,state FROM public.user
